...
// sample 3: 0.5, 0.3, 0.15, 0.05
// sample 4: 0.4, 0.3, 0.2, 0.1
	...
	for(int y=0; y<12; y++){
		for(int x=0; x<12; x++){
			...
			if(mapStat[x][y] != 0 || ava[x][y] == 0){
				...
				if(sum_step_size < min_step_length && sum_step_size >=10){
